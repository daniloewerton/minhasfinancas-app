                    ...
                    <div className="col-lg-12">
                        <div className="bs-component">
                            ...
                            <FormGroup label="Repita a Senha: *" htmlFor="inputRepitaSenha">
                                <input type="password" className="form-control" id="inputRepitaSenha" name="repitaSenha" onChange={e => this.setState({ senhaRepeticao: e.target.value })} />
                            </FormGroup>

                            <button onClick={ this.cadastrar } type="buttom" className="btn btn-success mt-3">Salvar</button>
                            <button onClick={ this.cancelar } type="buttom" className="btn btn-danger mt-3">Cancelar</button>
                        </div>
                    </div>
                </div>
            </Card>
